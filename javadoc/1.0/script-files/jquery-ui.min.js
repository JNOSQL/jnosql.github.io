      ...
      _on: function (n, o, t) {
        ...
        "boolean" != typeof n && ((t = o), (o = n), (n = !1)),
          ...
          x.each(t, function (t, e) {
            ...
            var t = t.match(/^([\w:-]*)\s*(.*)$/),
              s = t[1] + a.eventNamespace,
              t = t[2];
            t ? l.on(s, t, i) : o.on(s, i);
          });
      },
      _off: function (t, e) {
        (e =
        ...
        ? ((g =
          ...
          x.each(["my", "at"], function () {
            ...
            ((i =
              ...
              (c[this] = [r.exec(i[0])[0], r.exec(i[1])[0]]);
          }),
          1 === b.length && (b[1] = b[0]),
          "right" === c.at[0]
            ? (v.left += m)
          ...
          this.each(function () {
            var i,
              ...
              u = x.extend({}, v),
              h = E(w.my, l.outerWidth(), l.outerHeight());
            "right" === c.my[0]
              ? (u.left -= a)
              ...
              c.using &&
                (t = function (t) {
                  ...
                  m < a && k(e + i) < m && (o.horizontal = "center"),
                    f < r && k(s + n) < f && (o.vertical = "middle"),
                    C(k(e), k(i)) > C(k(s), k(n))
        ...
        left: function (t, e) {
          ...
          s < e.collisionWidth
            ? 0 < l && a <= 0
              ...
              : (t.left =
                  !(0 < a && l <= 0) && a < l ? n + s - e.collisionWidth : n)
            : 0 < l
            ? (t.left += l)
            : 0 < a
            ? (t.left -= a)
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            u = -2 * e.offset[0];
          l < 0
            ? ((n = t.left + a + r + u + e.collisionWidth - n - s) < 0 ||
                n < k(l)) &&
              (t.left += a + r + u)
            : 0 < o &&
              (0 <
                (s = t.left - e.collisionPosition.marginLeft + a + r + u - i) ||
                k(s) < o) &&
              (t.left += a + r + u);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            u = -2 * e.offset[1];
          l < 0
            ? ((n = t.top + a + r + u + e.collisionHeight - n - s) < 0 ||
                n < k(l)) &&
              (t.top += a + r + u)
            : 0 < o &&
              (0 <
                (s = t.top - e.collisionPosition.marginTop + a + r + u - i) ||
                k(s) < o) &&
              (t.top += a + r + u);
        },
      },
